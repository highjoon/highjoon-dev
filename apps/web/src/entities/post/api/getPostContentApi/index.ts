...
import { escapeInlineHtmlTags } from '@/entities/post/api/getPostContentApi/escapeInlineHtmlTags';
import { fixBoldAfterPunctuation } from '@/entities/post/api/getPostContentApi/fixBoldAfterPunctuation';
...
export const getPostContentApi = async (params: GetPostContentRequestDto) => {
  ...
  return fixBoldAfterPunctuation(escapeInlineHtmlTags(content));
};
